...
if prompt := st.chat_input("Ask me anything about movies"):
    ...
    response, full_response = get_chatbot_response(prompt, st.session_state.chat_history)

    st.session_state.chat_history.extend([HumanMessage(content=prompt) , response])    
